                        ...
                        <>
                          ...
                          <div className="details-info">
                            ...
                            <div className="date-where">
                              ...
                              <p className="date">13-14.12.24</p>
                            </div>
                          ...
                          {/* <div className="details-info">
                            ...
                            <div className="date-where">
                              ...
                              <p className="date">15.12.24</p>
                            </div>
                            <div className="reservation">
                              <Link href="/pow-store/produkt/ii-sits-egzamin-weryfikacyjny/" className="link-to-shop">
                                <GiPlayButton
                                  className="checks"
                                  style={{ marginRight: 5 }}
                                />
                          ...
                          <div className="details-info">
                            <div className="title-programm">
                              <p>
                                Kurs doszkalający <br /> Technika + buttering
                              </p>
                            </div>
                          ...
                          <div className="details-info">
                            ...
                            <div className="date-where">
                              ...
                              <p className="date">15-16.02.25</p>
                            </div>
                            <div className="reservation">
                              <Link
                                href="/pow-store/produkt/ii-sits-kurs-doszkalajacy-2-dniowy/"
                        ...
                        <>
                          ...
                          <div className="details-info">
                            ...
                            <div className="date-where ot2">
                              ...
                              <p className="date">15-21.12.24</p>
                            </div>
                            <div className="reservation">
                              <p style={{ marginBottom: "5px" }}>
                                (Wyprzedane)
                              ...
                              <Link
                                href="/pow-store/produkt/asystent-instruktora-sits/"
                                className="link-to-shop"
                              >
                                <GiPlayButton
                                  className="checks"
                          ...
                          <div className="details-info">
                            ...
                            <div className="date-where ot2">
                              ...
                              <p className="date">17-23.02.25</p>
                            </div>
                            <div className="reservation">
                              <Link
                                href="/pow-store/produkt/asystent-instruktora-sits/"
